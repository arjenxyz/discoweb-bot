...
client.on('interactionCreate', async (interaction) => {
    ...
    // ─── Select menu'ler artık web panelinden yönetiliyor ────────────────────
    if (interaction.isStringSelectMenu()) {
        try { await interaction.reply({ content: '⚙️ Raporlar artık **web panelinden** yönetiliyor.', ephemeral: true }); } catch { /* ignore */ }
        return;
    }
    // ─────────────────────────────────────────────────────────────────────────
